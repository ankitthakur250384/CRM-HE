import{q as l,g as p}from"./dbConnection-CgqPlxsn.js";import"./index-wPsXXX6e.js";const h=async()=>{try{console.log("Getting all deals directly from PostgreSQL database");const s=await l(`
      SELECT d.*, 
