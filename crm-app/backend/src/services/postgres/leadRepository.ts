...
export const updateLeadAssignment = async (
  ...
  try {
    ...
    console.log(`${actionType} lead ${leadId} ${salesAgentId === '' ? '' : `to ${salesAgentName}`}`);
 ...
 * Retrieves a single record from the 'leads' table
 */
 ...
 * Updates fields in the 'leads' table
 */
 ...
 * Deletes a record from the 'leads' table
 */
